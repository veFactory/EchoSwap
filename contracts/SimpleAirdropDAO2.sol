...
contract SimpleAirdropDAO2 {
    ...
    constructor() {
        ...
        echo = address(0xF4C8E32EaDEC4BFe97E0F595AdD0f4450a863a11);
    ...
    function distributeAirdrop(address[] memory users) external onlyOwner {
        uint i = 0;
        address _user;
        for(i; i < users.length; i++){
            _user = users[i];
            IERC20(echo).approve(ve, 0);
            IERC20(echo).approve(ve, amountPerUser);
